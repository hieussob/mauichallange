namespace ClothingFashion.UI
{
    public class AppColors
    {
        ...
        public static Color Pink = Colors.Pink;
        public static Color Gray = Colors.Gray;
        public static Color LightGray = Colors.LightGray;
        public static Color DarkGray = Color.FromRgba("#3A3A3A");
        public static Color Transparent = Colors.Transparent;
        public static Color CharcoalGray = Color.FromRgba("#191919");
        public static Color SoftGray = Color.FromRgba("#C5C5C5");
        public static Color SoftBlack = Color.FromRgba("##1D2C33");
    }
}
